export const seedData = {
  ...
  "edges": [
    ...
    },
    {
      ...
      "dates": "1903",
      "description": "Dmowski rozwinął koncepcję piastowskiej"
    },
    {
      "source": "poplawski_jan",
  ...
  "myths": [
    {
      ...
      "truth": "Liga Narodowa została założona w 1893 roku, 29 lat przed Marszem na Rzym Mussoliniego (1922), który zapoczątkował faszyzm. Endecja zawsze popierała demokrację parlamentarną, choć nacjonalistyczną. Faszyzm wymaga totalitaryzmu i kultu wodza, czego ND nigdy nie propagowała. ND uczestniczyła w Dumie (1906-1917) i Sejmie (1919-1939), co świadczy o akceptacji ustroju parlamentarnego.",
      "sources": [
        "Brian Porter, 'When Nationalism Began to Hate' (2000)",
        "Roman Wapiński, 'Narodowa Demokracja 1893-1939' (1980)",
        "Statut Ligi Narodowej (1893, archiwum AAN)"
      ],
      "severity": "wysoka",
      "relatedNodes": [
        "dmowski_roman",
    ...
    },
    {
      ...
      "truth": "Dmowski zmarł 2 stycznia 1939 roku, 8 miesięcy przed wybuchem II wojny światowej. Całe swoje życie ostrzegał przed zagrożeniem niemieckim (Drang nach Osten). Na konferencji w Wersalu (1919) występował po stronie Francji i Wielkiej Brytanii przeciwko interesom niemieckim. Jego polityka była jednoznacznie antyniemiecka.",
      "sources": [
        "Akt zgonu (2 stycznia 1939, USC Warszawa)",
        "'Polityka polska i odbudowanie państwa' (1925) - argumenty antyniemieckie",
        "Protokoły konferencji wersalskiej (1919)"
      ],
      "severity": "wysoka",
      "relatedNodes": [
        "dmowski_roman",
    ...
    },
    {
      ...
      "claim": "Narodowa Demokracja była przeciwna polskiej niepodległości",
      "truth": "ND dążyła do niepodległości drogą dyplomatyczną, a nie poprzez powstania. Dmowski kierował Komitetem Narodowym Polskim (uznanym przez aliantów w 1917), reprezentował Polskę w Wersalu (1919) i zabezpieczył granice w Traktacie Wersalskim. To właśnie działania dyplomatyczne ND przyczyniły się do odzyskania niepodległości.",
      "sources": [
        "Uznanie Komitetu Narodowego Polskiego przez aliantów (1917)",
        "Traktat Wersalski - postanowienia terytorialne Polski (1919)",
        "Roman Dmowski, 'Polityka polska...' (1925)"
      ],
      "severity": "wysoka",
      "relatedNodes": [
        "dmowski_roman",
    ...
    {
      "id": "mit4",
      "title": "Endecja była prorosyjska",
      "claim": "Endecja kolaborowała z Imperium Rosyjskim przeciwko Polsce",
      "truth": "Pragmatyczne podejście: ND postrzegała Niemcy jako większe zagrożenie niż Rosję (słusznie przewidując I wojnę światową). Praca w Dumie miała na celu uzyskanie autonomii polskiej przy jednoczesnym przeciwstawianiu się rusyfikacji. Po 1917 roku Endecja była zdecydowanie antybolszewicka. Uczestniczenie w wojnie polsko-sowieckiej 1920.",
      "sources": [
        "Przemówienia Dmowskiego w Dumie (1906-1909, archiwum)",
        "'Germany, Russia and the Polish Question' (1908)",
      ...
      "category": "polityka zagraniczna"
    },
    {
      "id": "mit5",
      "title": "Endecja była jednolitym ruchem",
      "claim": "Wszyscy narodowcy myśleli tak samo",
      "truth": "Istniały znaczące podziały ideologiczne: starsze pokolenie (Dmowski) kontra młodzi radykałowie (ONR). Poglądy ekonomiczne wahały się od liberalnych (Szkoła Krakowska) do korporacyjnych. Jednoczył ich rdzeń: suwerenność polska i tożsamość katolicka. Podział między 'starymi' a 'młodymi' w latach 30.",
      "sources": [
        "Zjazd Stronnictwa Narodowego 1935 (podział pokoleniowy)",
        "Debaty ekonomiczne Adam Krzyżanowski vs Stanisław Grabski",
        "Odłączenie ONR od SN (1934)"
      ],
      "severity": "niska",
      "relatedNodes": [
      ...
      "category": "struktura wewnętrzna"
    },
    {
      "id": "mit6",
      "title": "Endecja planowała Holokaust",
      "claim": "Narodowa Demokracja była odpowiedzialna za planowanie Holokaustu",
      "truth": "Holokaust był dziełem nazistowskich Niemiec (1941-1945). Dmowski zmarł w 1939, przed rozpoczęciem Holokaustu. Antysemityzm ND był natury ekonomiczno-kulturowej (bojkot gospodarczy, numerus clausus), nie rasowo-biologicznej jak u nazistów. ND nigdy nie postulowała fizycznej eksterminacji. Wielu członków ND uczestniczyło w podziemiu antynazistowskim.",
      "sources": [
        "Historiografia Holokaustu (odpowiedzialność niemiecka)",
        "Analiza programów ND (brak postulatu eksterminacji)",
        "Udział narodowców w podziemiu (AK, NSZ)"
      ],
      "severity": "krytyczna",
      "relatedNodes": [
        "dmowski_roman",
    ...
    {
      "id": "mit7",
      "title": "Endecja była partią jednej klasy",
      "claim": "Narodowa Demokracja reprezentowała tylko interesy burżuazji/inteligencji",
      "truth": "ND dążyła do ruchu ponadklasowego. Popławski redagował 'Polaka' dla chłopów. Młodzież Wszechpolska łączyła studentów, rzemieślników i robotników. Obóz Wielkiej Polski miał charakter masowy. Program socjalny obejmował wszystkie warstwy społeczne.",
      "sources": [
        "Miesięcznik 'Polak' (1900-1908)",
        "Struktura Młodzieży Wszechpolskiej",
        "Program społeczny OWP"
      ],
      "severity": "średnia",
      "relatedNodes": [
        "poplawski_jan",
        "polak",
        "owp",
        "mlodziez_wszechpolska"
      ],
      "category": "struktura społeczna"
    }
  ],
  "timeline": [
    {
      "year": 1854,
      "label": "Urodziny Popławskiego",
      "nodeId": "poplawski_jan",
      "description": "Narodziny Jana Ludwika Popławskiego, współzałożyciela ruchu narodowego"
    },
    {
      "year": 1858,
      "label": "Urodziny Balickiego",
      "nodeId": "balicki_zygmunt",
      "description": "Narodziny Zygmunta Balickiego, teoretyka egoizmu narodowego"
    },
    {
      "year": 1864,
      "label": "Urodziny Dmowskiego",
      "nodeId": "dmowski_roman",
      "description": "Narodziny Romana Dmowskiego, głównego ideologa Endecji"
    },
    {
      "year": 1887,
      "label": "Związek Młodzieży Polskiej 'Zet'",
      "nodeId": "balicki_zygmunt",
      "description": "Balicki zakłada Związek Młodzieży Polskiej 'Zet'"
    },
    {
      "year": 1893,
      "label": "Założenie Ligi Narodowej",
      "nodeId": "zalozenie_ligi",
      "description": "Dmowski, Popławski i Balicki założyli Ligę Narodową"
    },
    {
      "year": 1895,
      "label": "Powstanie Przeglądu Wszechpolskiego",
      "nodeId": "przeglad_wszechpolski",
      "description": "Popławski rozpoczyna wydawanie Przeglądu Wszechpolskiego"
    },
    {
      "year": 1897,
      "label": "Powstanie SND",
      "nodeId": "snd",
      "description": "Utworzenie Stronnictwa Narodowo-Demokratycznego"
    },
    {
      "year": 1902,
      "label": "Egoizm narodowy",
      "nodeId": "egoizm_narodowy",
      "description": "Balicki publikuje 'Egoizm narodowy wobec etyki'"
    },
    {
      "year": 1903,
      "label": "Myśli nowoczesnego Polaka",
      "nodeId": "mysli_polaka",
      "description": "Dmowski publikuje 'Myśli nowoczesnego Polaka'"
    },
    {
      "year": 1905,
      "label": "Rewolucja 1905",
      "nodeId": "rewolucja_1905",
      "description": "ND przeciwstawia się rewolucji"
    },
    {
      "year": 1906,
      "label": "Udział w Dumie",
      "nodeId": "udzial_w_dumie",
      "description": "ND zaczyna uczestniczyć w Dumie Rosyjskiej"
    },
    {
      "year": 1908,
      "label": "Śmierć Popławskiego",
      "nodeId": "poplawski_jan",
      "description": "Śmierć Jana Ludwika Popławskiego w Warszawie"
    },
    {
      "year": 1908,
      "label": "Niemcy, Rosja i kwestia polska",
      "nodeId": "niemcy_rosja",
      "description": "Dmowski publikuje geopolityczną analizę"
    },
    {
      "year": 1916,
      "label": "Śmierć Balickiego",
      "nodeId": "balicki_zygmunt",
      "description": "Śmierć Zygmunta Balickiego w Piotrogrodzie"
    },
    {
      "year": 1917,
      "label": "Komitet Narodowy Polski",
      "nodeId": "komitet_narodowy",
      "description": "Dmowski kieruje Komitetem Narodowym Polskim"
    },
    {
      "year": 1919,
      "label": "Konferencja w Wersalu",
      "nodeId": "konferencja_paryska",
      "description": "Dmowski reprezentuje Polskę w Wersalu"
    },
    {
      "year": 1922,
      "label": "Młodzież Wszechpolska",
      "nodeId": "mlodziez_wszechpolska",
      "description": "Powstanie Młodzieży Wszechpolskiej"
    },
    {
      "year": 1926,
      "label": "Zamach Majowy",
      "nodeId": "zamach_majowy",
      "description": "Piłsudski dokonuje zamachu stanu"
    },
    {
      "year": 1926,
      "label": "Obóz Wielkiej Polski",
      "nodeId": "powstanie_owp",
      "description": "Dmowski powołuje do życia OWP"
    },
    {
      "year": 1927,
      "label": "Kościół, Naród i Państwo",
      "nodeId": "kosciol_narod",
      "description": "Dmowski publikuje broszurę programową OWP"
    },
    {
      "year": 1928,
      "label": "Stronnictwo Narodowe",
      "nodeId": "powstanie_sn",
      "description": "Powstanie Stronnictwa Narodowego"
    },
    {
      "year": 1929,
      "label": "Akademik i polityka",
      "nodeId": "akademik_polityka",
      "description": "Mosdorf publikuje program Młodzieży Wszechpolskiej"
    },
    {
      "year": 1934,
      "label": "Powstanie ONR",
      "nodeId": "onr",
      "description": "Odłączenie się radykalnych młodych narodowców"
    },
    {
      "year": 1936,
      "label": "Siła i prawo",
      "nodeId": "sila_prawo",
      "description": "Rybarski publikuje analizę polityczną"
    },
    {
      "year": 1939,
      "label": "Śmierć Dmowskiego",
      "nodeId": "smierc_dmowskiego",
      "description": "Śmierć Romana Dmowskiego w Warszawie, 2 stycznia"
    },
    {
      "year": 1886,
      "label": "Tygodnik Głos",
      "nodeId": "powstanie_glosu",
      "description": "Popławski współtworzy Głos"
    },
    {
      "year": 1887,
      "label": "Związek 'Zet'",
      "nodeId": "powstanie_zetu",
      "description": "Balicki zakłada Zet"
    },
    {
      "year": 1887,
      "label": "Dmowski w Lidze Polskiej",
      "nodeId": "liga_polska",
      "description": "Dmowski dołącza do Ligi Polskiej"
    },
    {
      "year": 1920,
      "label": "Wojna polsko-sowiecka",
      "nodeId": "wojna_polsko_sowiecka",
      "description": "Konflikt z Rosją sowiecką"
    },
    {
      "year": 1922,
      "label": "Wybory 1922",
      "nodeId": "wybory_1922",
      "description": "Pierwsze wybory parlamentarne"
    },
    {
      "year": 1933,
      "label": "Rozwiązanie OWP",
      "nodeId": "rozwiazanie_owp",
      "description": "Sanacja rozwiązuje OWP"
    },
    {
      "year": 1942,
      "label": "Śmierć Rybarskiego",
      "nodeId": "rybarski_roman",
      "description": "Rybarski ginie w Auschwitz"
    },
    {
      "year": 1943,
      "label": "Śmierć Mosdorfa",
      "nodeId": "mosdorf_jan",
      "description": "Śmierć Jana Mosdorfa"
    }
  ],
  "sources": [
    {
      ...
      "title": "Myśli nowoczesnego Polaka",
      "year": 1903,
      "description": "Fundamentalne dzieło Dmowskiego, manifest polskiego nacjonalizmu",
      "language": "polski",
      "availability": "domena publiczna"
    },
    {
      "id": "src2",
      "type": "book",
      ...
      "title": "Egoizm narodowy wobec etyki",
      "year": 1902,
      "description": "Kluczowa praca teoretyczna definiująca egoizm narodowy",
      "language": "polski",
      "availability": "domena publiczna"
    },
    {
      ...
      "title": "Niemcy, Rosja i kwestia polska",
      "year": 1908,
      "description": "Analiza geopolityczna uzasadniająca orientację prorosyjską",
      "language": "polski"
    },
    {
      "id": "src4",
      ...
      "title": "Polityka polska i odbudowanie państwa",
      "year": 1925,
      "description": "Wspomnienia polityczne Dmowskiego z okresu walki o niepodległość",
      "language": "polski"
    },
    {
      "id": "src5",
      ...
      "title": "Kościół, Naród i Państwo",
      "year": 1927,
      "description": "Broszura programowa OWP o związku katolicyzmu z narodem",
      "language": "polski"
    },
    {
      "id": "src6",
      ...
      "title": "Pisma polityczne",
      "year": 1908,
      "description": "Zbiór pism politycznych Popławskiego wydany pośmiertnie",
      "language": "polski"
    },
    {
      "id": "src7",
      ...
      "year": 1904,
      "publication": "Polak",
      "description": "Definicja narodu i narodowości",
      "language": "polski"
    },
    {
      "id": "src8",
      ...
      "title": "Akademik i polityka",
      "year": 1929,
      "edition": "drugie, poprawione i uzupełnione",
      "publisher": "Akademik Polski, Warszawa",
      "description": "Program młodzieży akademickiej ruchu narodowego",
      "language": "polski"
    },
    {
      "id": "src9",
      ...
      "title": "Siła i prawo",
      "year": 1936,
      "publisher": "Zakład Drukarski F. Wyszyński i S-ka, Warszawa",
      "description": "Analiza stosunku siły do prawa w życiu politycznym",
      "language": "polski"
    },
    {
      "id": "src10",
      ...
      "description": "Anglojęzyczna analiza polskiego nacjonalizmu",
      "language": "angielski"
    },
    {
      "id": "src11",
      ...
      "title": "Narodowa Demokracja 1893-1939",
      "year": 1980,
      "description": "Kompleksowa historia ruchu narodowo-demokratycznego",
      "language": "polski"
    },
    {
      "id": "src12",
      ...
      "title": "Józef Piłsudski 1867-1935",
      "year": 1988,
      "description": "Biografia Józefa Piłsudskiego",
      "language": "polski"
    },
    {
      "id": "src13",
      ...
      "title": "Przewrót majowy 1926",
      "year": 1979,
      "description": "Analiza zamachu majowego Piłsudskiego",
      "language": "polski"
    },
    {
      "id": "src14",
      ...
      "title": "Grabski biography",
      "year": 1985,
      "description": "Biografia Władysława Grabskiego",
      "language": "polski"
    },
    {
      "id": "src15",
      ...
      "year": 1893,
      "archive": "Archiwum Akt Nowych",
      "description": "Dokumenty założycielskie Ligi Narodowej",
      "language": "polski"
    },
    {
      "id": "src16",
      "type": "archival",
      "title": "Przemówienia Dmowskiego w Dumie",
      "years": "1906-1909",
      "archive": "Russian State Archive",
      "description": "Archiwalne przemówienia Dmowskiego w Dumie Rosyjskiej",
      "language": "polski/rosyjski"
    },
    {
      "id": "src17",
      "type": "treaty",
      "title": "Traktat Wersalski - postanowienia dotyczące Polski",
      "year": 1919,
      "description": "Postanowienia terytorialne dotyczące Polski",
      "language": "francuski/angielski"
    },
    {
      "id": "src18",
      "type": "archival",
      "title": "Akt zgonu Romana Dmowskiego",
      "date": "1939-01-02",
      "location": "Urząd Stanu Cywilnego Warszawa",
      "description": "Oficjalny akt zgonu Romana Dmowskiego",
      "language": "polski"
    },
    {
      "id": "src19",
      "type": "periodical",
      "title": "Przegląd Wszechpolski",
      "years": "1895-1905",
      "editor": "Jan Ludwik Popławski",
      "description": "Główna gazeta ruchu narodowego",
      "language": "polski",
      "archive": "Wielkopolska Biblioteka Cyfrowa"
    },
    {
      "id": "src20",
      "type": "periodical",
      ...
      "years": "1900-1908",
      "editor": "Jan Ludwik Popławski",
      "description": "Miesięcznik dla chłopów",
      "language": "polski"
    },
    {
      "id": "src21",
      "type": "website",
      "title": "Cyfrowa Biblioteka Myśli Narodowej",
      "url": "https://cbmn.pl",
      "description": "Cyfrowe archiwum dzieł polskiej myśli narodowej",
      "language": "polski",
    ...
    },
    {
      ...
      "author": "Zygmunt Balicki",
      "title": "Psychologia społeczna",
      "description": "Analiza psychologii mas i zachowań zbiorowych",
      "language": "polski"
    },
    {
      "id": "src23",
      ...
      "author": "Zygmunt Balicki",
      "title": "Zasady wychowania narodowego",
      "description": "Program edukacji narodowej",
      "language": "polski"
    },
    {
      "id": "src24",
      ...
      "description": "Koncepcja gospodarki narodowej",
      "language": "polski"
    },
    {
      "id": "src25",
      ...
      "author": "Roman Rybarski",
      "title": "Naród, jednostka i klasa",
      "description": "Analiza stosunku jednostki do narodu",
      "language": "polski"
    },
    {
      "id": "src26",
      ...
      "title": "Głos",
      "years": "1886-1890s",
      "founder": "Jan Ludwik Popławski",
      "description": "Wczesny tygodnik narodowo-demokratyczny",
      "language": "polski"
    }
  ]
};