...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Trigger
    ...
    className={cn(
      ...
      "border-endecja-gold/30 bg-white text-endecja-ink placeholder-endecja-light focus:border-endecja-gold focus:ring-endecja-gold", // Custom theme
      className
    )}
    {...props}
  >
  ...
  <SelectPrimitives.Portal>
    <SelectPrimitives.Content
      ...
      className={cn(
        ...
        "bg-white border-endecja-gold/20 text-endecja-ink", // Custom theme
        className
      )}
      position={position}
      {...props}
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitives.Item
    ...
    className={cn(
      ...
      "focus:bg-endecja-gold/10 focus:text-endecja-ink", // Custom theme
      className
    )}
    {...props}
  >
