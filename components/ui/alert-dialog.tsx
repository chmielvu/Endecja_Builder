...
import { Button, buttonVariants } from "./button"; // FIX: Import buttonVariants
  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitives.Content
      ...
      className={cn(
        ...
        "bg-endecja-paper border-endecja-gold text-endecja-ink", // Custom theme
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitives.Action
    ref={ref}
    // FIX: Use buttonVariants directly with default variant and size
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitives.Cancel
    ref={ref}
    // FIX: Use buttonVariants directly with outline variant and default size
    className={cn(
