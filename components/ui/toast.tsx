  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "default" && "border bg-white text-endecja-ink",
        variant === "destructive" &&
          "destructive group border-red-600 bg-red-600 text-endecja-paper",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium transition-colors hover:bg-endecja-gold/20 focus:outline-none focus:ring-2 focus:ring-endecja-gold focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-slate-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-endecja-paper group-[.destructive]:focus:ring-red-500",
      className
    )}
    {...props}
  />
...
type ToastProps = React.ComponentPropsWithoutRef<typeof Toast> & { variant?: "default" | "destructive" };
